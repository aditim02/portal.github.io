...
if (empty($_POST['date']) || empty($_POST['name']) || empty($_POST['cost']) ||empty($_POST['emd'])||empty($_POST['deposit'])||empty($_POST['time'])||empty($_POST['note'])){
...
$query = "INSERT into tender (date,name,cost,emd,deposit,time,note) VALUES('$date','$name','$cost','$emd','$deposit','$time','$note')";
                                ...
                                <div class="banner">
                                    <section class="container">
                                         ...
                                         <div class= "agile-voltsub">
                                                ...
                                                <h2>E-tender Form</h2>
                                                <form action= "etender.php" method= "POST" >
                                                                <div class= "agile-email" >
                                                                        <p> Tender date
                                                                        <input type= "date" name="date" id= "date" placeholder= "Enter tender date" required= ""/></p>
                                                                </div>
                                                                ...
                                                                <div class= "agile-email" >
                                                                        <p> Tender cost</p>
                                                                        <input type= "number" name="cost" id= "cost" placeholder= "enter tender cost" required= ""/>
                                                                </div>
                                                                
                                                                <div class="agile-address">
                                                                        <p>EMD</p>
                                                                        <input type="text" name="emd" id="emd" placeholder="emd" required="" />
                                                                </div>
                                                                
                                                                <div class= "agile-city" >
                                                                        <p>Tender Deposit</p>
                                                                        <input type="number" name="deposit" id="deposit" placeholder="Tender deposit"required="" />
                                                                </div>
                                                                
                                                                <div class= "agile-city" >
                                                                        <p>Time for completion</p>
                                                                        <input type="number" name="time" id="time" placeholder="Time for completion in hours"required="" />
                                                                </div>

                                                                <div class= "agile-city" >
                                                                        <p>Note</p>
                                                                        <input type="text" name="note" id="note" placeholder="Note if any" required=""/>
                                                                </div>
