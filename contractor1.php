...
<!--                                                         <li class="dropdown">
						...
						<li class="dropdown">
							...
							<li><a href="contact.html">Contact</a></li>
                                      ...
                                      <h2 align="center">E-tenders</h2>
                                      <form action="contractor1.php" method="POST"> 
                                      <table class="table table-striped">
                                          <font size="2" face="Courier New" colour="black" >
                                        <thead class="thead-dark">
                                            <tr class="table-striped">
                                            <th>Tender no</th>
                                            <th><b>Tender date</b></th>
                                            <th>Tender name</th>
                                            <th>Tender cost</th>
                                            <th>EMD</th>
                                            <th>Tender Deposit</th>
                                    ...
                                    <td name="cname"><?php echo $row->date;?></td>
                                    <td><?php echo $row->name;?></td>
                                    <td><?php echo $row->cost;?></td>
                                    <td><?php echo $row->emd;?></td>
