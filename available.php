...
if (empty($_POST['area']) || empty($_POST['no']) || empty($_POST['type'])|| empty($_POST['charges'])|| empty($_POST['cost']) ) {
...
$query = "INSERT into available (area,no,type,charges,cost) VALUES ('$area','$no','$type','$charges','$cost')";
...
<!--Displays the form filled up by workers and admin will publish the availability of workers -->
<!DOCTYPE html>
<html lang="en">
<head>
                                            ...
                                            <section class= "agile-volt">
                                               ...
                                               <div class= "agile-voltsub">
                                                       ...
                                                       <form action= "worker1.php" method= "POST" >
                                                                       ...
                                                                       <div class="agile-address">
                                                                               <p>Charges</p>
                                                                               <input type="number" name="charges" id="charges" placeholder="enter the charges" required="" />
                                                                       </div>
                                                                       <div class= "clear" > </div>
                                                                       <div class="agile-address">
                                                                               <p>Total Cost</p>
                                                                               <input type="number" name="cost" id="cost" placeholder="enter the cost" required="" />
                                                                       </div>
