...
if (empty($_POST['tname']) || empty($_POST['type']) || empty($_POST['tdesc']) ||empty($_POST['tdate'])) {
...
$query = "INSERT into itender (tname,type,tdesc,tdate) VALUES ('$tname','$type','$tdesc','$tdate')";
...
<!--						<li class="menu-list"><a href="#"><i class="lnr lnr-book"></i>  <span>Pages</span></a> 
				...
				<div class="user-panel-top">  	
					...
					<div class="social_icons">
						<div class="col-md-4 social_icons-left">
							<a href="#" class="yui"><i class="fa fa-facebook i1"></i><span>300+Likes</span></a>
						</div>
						<div class="col-md-4 social_icons-left pinterest">
							<a href="#"><i class="fa fa-google-plus i1"></i><span>500+Shares</span></a>
						</div>
	...
	<section class= "agile-volt">
		...
		<div class= "agile-voltheader">
			<h1>Internal <label>Tender</label> form</h1>
		</div>
		<div class= "agile-voltsub">
			<h2>Sign Up</h2>
                        <form action= "itender.php" method= "POST" >
					<div class= "agile-name" >
						<p>tender name</p>
						<input type= "text" name="tname" id="tname" placeholder= "enter tender name" required= ""/>
					</div>
					<div class= "clear"> </div>
					<div class= "agile-email" >
						<p> tender type</p>
						<input type= "text" name="type" id= "type" placeholder= "Tender type" required= ""/>
					</div>
					<div class="clear"></div>
					<div class="agile-address">
						<p>Tender Desc</p>
                                                <input type="text" name="tdesc" id="tdesc" placeholder="tender desc" required="" />
					</div>
					<div class= "clear" > </div>
					<div class= "agile-city" >
						<p>Tender date</p>
                                                <input type="date" name="tdate" id="tdate" placeholder="tender date" required="">
					</div>
					<div class="clear"></div>
