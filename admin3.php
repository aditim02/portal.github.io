	...
	<div class="banner">
		<div class="mycontent">
                     <section class="container">
                                                ...
                                                <h2 align="center">User Requirement Requests</h2>
                                               ...
                                               <td>><a href=admin.php?id=<?php echo $row->name;?> class="btn btn-outline-sucess" role="button">VERIFY</a></td>  
                                                   </form>
