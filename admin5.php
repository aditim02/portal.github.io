...
<!-- banner -->
	<div class="banner">
		<div class="container">
                                      ...
                                      <h2 align="center">User Requests</h2>
                                    ...
                                    $query = "SELECT * from user where authorize=''";
                                    ...
                                    <td><a href=uverify.php?id=<?php echo $row->username;?> class="btn btn-outline-sucess" role="button">Verify</a></td>   
                                    <td><a href=admin5.php?id=<?php $conn = mysqli_connect("localhost:3307", "root", "", "newproject"); $query = "Delete from user where username='$row->username'"; mysqli_query($conn, $query);echo($query);?> class="btn btn-outline-sucess" role="button">Delete</a></td>--> 
                                    </tr>
                                      </form>
                                     <?php
                                    $cnt=$cnt+1;
