 ...
 $conn = mysqli_connect("localhost:3307", "root", "", "newproject");
   ...
   $select_id = 'yes';     
  //if ($select_id == 'yes') {
      $query="UPDATE contractor SET authorize='$select_id' WHERE username='$cname';";
    echo $query;
...
<div class="mycontent">
  ...
  <h3 align="center"> Verified Contractor Requests</h3>
...
$query = "SELECT * from contractor where authorize='yes'";
