...
if (empty($_POST['uname']) || empty($_POST['requirement']) || empty($_POST['quantity'])){
...
$query = "INSERT into material (uname,requirement,quantity)VALUES('$uname','$requirement','$quantity')";
//echo("Your form has been recorded for verification");

if (mysqli_query($conn, $query)) {
  echo "Your requirement has been recored successfully";
} else {
...
<!--									<li><a href="etender.php">E-tenders</a></li>-->
		...
		<div class= "agile-voltheader">
			<h1> Materials Requirements form</h1>
		</div>
		<div class= "agile-voltsub">
			<h2>Enter Details</h2>
					...
					<div class= "agile-email" >
						<p> Requirement of material:</p>
						<input type= "text" name="requirement" id= "requirement" placeholder= "Your requirement" required= ""/>
					</div>
					<div class="clear"></div>
