...
<!-- banner -->
	<div class="banner">
		<div class="container">
                                      ...
                                      <h2 align="center">Contractor Requests</h2>
                                    ...
                                    $query = "SELECT * from contractor where authorize=''";
                                    ...
                                    <td username="cname"><?php echo $row->username;?></td>
                                    <td><?php echo $row->password;?></td>
                                    <td><?php echo $row->mobileno;?></td>
                                    <td><?php echo $row->email;?></td>
                                  
                                    <td><a href=cverify.php?id=<?php echo $row->username;?> class="btn btn-outline-sucess" role="button">Verify</a></td>   
                                    <td><a href=admin6.php?id=<?php $conn = mysqli_connect("localhost:3307", "root", "", "newproject"); $query = "Delete from contractor where username='$row->username'"; mysqli_query($conn, $query);echo($query);?> class="btn btn-outline-sucess" role="button">Delete</a></td>--> 
                                    </tr>
                                      </form>
                                     <?php
                                    $cnt=$cnt+1;
