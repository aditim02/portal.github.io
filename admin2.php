 ...
 $conn = mysqli_connect("localhost:3307", "root", "", "newproject");
   ...
   $select_id = 'yes';     
  //if ($select_id == 'yes') {
      $query="UPDATE request SET authorize='$select_id' WHERE name='$cname';";
    echo $query;
...
<!--						<li class="menu-list"><a href="#"><i class="lnr lnr-book"></i>  <span>Pages</span></a> 
		...
		<div class="main-content">
			...
			<!--notification menu end -->
                        ...
                        <div class="mycontent">
                           <div class="container">
                          <h3 align="center"> Verified Dealer Requests</h3>
                        ...
                        $query = "SELECT * from request where authorize='yes'";
