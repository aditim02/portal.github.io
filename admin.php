						...
						<ul class="nav navbar-nav">
							...
							<li><a href="register.php">Register</a></li>
								...
								<ul class="dropdown-menu agile_short_dropdown">
                                                                    ...
                                                                    <li><a href="itender.php">Internal tender</a></li>
                                                                    <li><a href="admin4.php">Tender results</a></li>
                                                                        <li><a href="contractor.php">Contractor</a></li>
								</ul>
							</li>
		...
		<div class="main-content">
			...
			<!--notification menu end -->
                        ...
                        <div class="banner">
                                      ...
                                      <h2 align="center">Dealer Requests</h2>
                                    ...
                                    $query = "SELECT * from request where authorize=''";
                                    ...
                                    <td><?php echo $row->shopadd;?></td>
                                    <td><?php echo $row->tom;?></td>
                                    <td><?php echo $row->services;?></td>
                                    <td><a href=admin2.php?id=<?php echo $row->name;?> class="btn btn-outline-sucess" role="button">Verify</a></td>   
                                    <td><a href=?id=<?php $conn = mysqli_connect("localhost:3307", "root", "", "newproject"); $query = "Delete from request where name='$row->name'"; mysqli_query($conn, $query);echo($query);?> class="btn btn-outline-sucess" role="button">Delete</a></td> 
                                    </tr>
                                      </form>
                                     <?php
                                    $cnt=$cnt+1;
