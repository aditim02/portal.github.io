...
if (empty($_POST['username']) || empty($_POST['password']) || empty($_POST['mobile']) ||empty($_POST['email'])) {
...
$query = "INSERT into contractor (username,password,mobile,email) VALUES ('$username','$password','$mobile','$email')";
...
<!--									<li><a href="etender.php">E-tenders</a></li>-->
	...
	<section class= "agile-volt">
		...
		<div class= "agile-voltheader">
			<h1>Contractor <label>Sign Up</label> form</h1>
		</div>
