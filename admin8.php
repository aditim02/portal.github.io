...
$query = "UPDATE material SET assign='$dealer' where id='$cnt'";
			...
			<!--notification menu end -->
		        ...
		        <div class="container">
                           ...
                           <div class="modal-content"> 
                               <h3 align="center"><b>User requirement</b></h3>
                            <table class="table table-striped">
                              ...
                              <?php
                                    ...
                                    $conn = mysqli_connect("localhost:3307", "root", "", "newproject");
                                    // SQL query to fetch information of registerd users and finds user match.
                                    $query = "SELECT * from material where assign=''";
                                    ...
                                    <td>
                                        <?php $queryy="Select name from request where authorize='yes'" ;
                                        ...
                                        <form action="admin8.php" method="POST">
                                        <td><input type="text" name="dealer" placeholder="enter dealer name"/></td>
